...
var VERBS_DATA = [
    { inf: 'hablar', reg: true, zh: '说话', forms: { present: { yo:'hablo', tu:'hablas', el:'habla', nosotros:'hablamos', vosotros:'habláis', ellos:'hablan' }, preterite: { yo:'hablé', tu:'hablaste', el:'habló', nosotros:'hablamos', vosotros:'hablasteis', ellos:'hablaron' }, subjunctive: { yo:'hable', tu:'hables', el:'hable', nosotros:'hablemos', vosotros:'habléis', ellos:'hablen' }, imperativoTu: { tu:'habla', tuNeg:'no hables' } } },
    { inf: 'trabajar', reg: true, zh: '工作', forms: { present: { yo:'trabajo', tu:'trabajas', el:'trabaja', nosotros:'trabajamos', vosotros:'trabajáis', ellos:'trabajan' }, preterite: { yo:'trabajé', tu:'trabajaste', el:'trabajó', nosotros:'trabajamos', vosotros:'trabajasteis', ellos:'trabajaron' }, subjunctive: { yo:'trabaje', tu:'trabajes', el:'trabaje', nosotros:'trabajemos', vosotros:'trabajéis', ellos:'trabajen' }, imperativoTu: { tu:'trabaja', tuNeg:'no trabajes' } } },
    { inf: 'estudiar', reg: true, zh: '学习', forms: { present: { yo:'estudio', tu:'estudias', el:'estudia', nosotros:'estudiamos', vosotros:'estudiáis', ellos:'estudian' }, preterite: { yo:'estudié', tu:'estudiaste', el:'estudió', nosotros:'estudiamos', vosotros:'estudiasteis', ellos:'estudiaron' }, subjunctive: { yo:'estudie', tu:'estudies', el:'estudie', nosotros:'estudiemos', vosotros:'estudiéis', ellos:'estudien' }, imperativoTu: { tu:'estudia', tuNeg:'no estudies' } } },
    { inf: 'comprar', reg: true, zh: '买', forms: { present: { yo:'compro', tu:'compras', el:'compra', nosotros:'compramos', vosotros:'compráis', ellos:'compran' }, preterite: { yo:'compré', tu:'compraste', el:'compró', nosotros:'compramos', vosotros:'comprasteis', ellos:'compraron' }, subjunctive: { yo:'compre', tu:'compres', el:'compre', nosotros:'compremos', vosotros:'compréis', ellos:'compren' }, imperativoTu: { tu:'compra', tuNeg:'no compres' } } },
    { inf: 'comer', reg: true, zh: '吃', forms: { present: { yo:'como', tu:'comes', el:'come', nosotros:'comemos', vosotros:'coméis', ellos:'comen' }, preterite: { yo:'comí', tu:'comiste', el:'comió', nosotros:'comimos', vosotros:'comisteis', ellos:'comieron' }, subjunctive: { yo:'coma', tu:'comas', el:'coma', nosotros:'comamos', vosotros:'comáis', ellos:'coman' }, imperativoTu: { tu:'come', tuNeg:'no comas' } } },
    { inf: 'beber', reg: true, zh: '喝', forms: { present: { yo:'bebo', tu:'bebes', el:'bebe', nosotros:'bebemos', vosotros:'bebéis', ellos:'beben' }, preterite: { yo:'bebí', tu:'bebiste', el:'bebió', nosotros:'bebimos', vosotros:'bebisteis', ellos:'bebieron' }, subjunctive: { yo:'beba', tu:'bebas', el:'beba', nosotros:'bebamos', vosotros:'bebáis', ellos:'beban' }, imperativoTu: { tu:'bebe', tuNeg:'no bebas' } } },
    { inf: 'aprender', reg: true, zh: '学会', forms: { present: { yo:'aprendo', tu:'aprendes', el:'aprende', nosotros:'aprendemos', vosotros:'aprendéis', ellos:'aprenden' }, preterite: { yo:'aprendí', tu:'aprendiste', el:'aprendió', nosotros:'aprendimos', vosotros:'aprendisteis', ellos:'aprendieron' }, subjunctive: { yo:'aprenda', tu:'aprendas', el:'aprenda', nosotros:'aprendamos', vosotros:'aprendáis', ellos:'aprendan' }, imperativoTu: { tu:'aprende', tuNeg:'no aprendas' } } },
    { inf: 'vivir', reg: true, zh: '居住；生活', forms: { present: { yo:'vivo', tu:'vives', el:'vive', nosotros:'vivimos', vosotros:'vivís', ellos:'viven' }, preterite: { yo:'viví', tu:'viviste', el:'vivió', nosotros:'vivimos', vosotros:'vivisteis', ellos:'vivieron' }, subjunctive: { yo:'viva', tu:'vivas', el:'viva', nosotros:'vivamos', vosotros:'viváis', ellos:'vivan' }, imperativoTu: { tu:'vive', tuNeg:'no vivas' } } },
    { inf: 'escribir', reg: true, zh: '写', forms: { present: { yo:'escribo', tu:'escribes', el:'escribe', nosotros:'escribimos', vosotros:'escribís', ellos:'escriben' }, preterite: { yo:'escribí', tu:'escribiste', el:'escribió', nosotros:'escribimos', vosotros:'escribisteis', ellos:'escribieron' }, subjunctive: { yo:'escriba', tu:'escribas', el:'escriba', nosotros:'escribamos', vosotros:'escribáis', ellos:'escriban' }, imperativoTu: { tu:'escribe', tuNeg:'no escribas' } } },
    { inf: 'abrir', reg: true, zh: '打开', forms: { present: { yo:'abro', tu:'abres', el:'abre', nosotros:'abrimos', vosotros:'abrís', ellos:'abren' }, preterite: { yo:'abrí', tu:'abriste', el:'abrió', nosotros:'abrimos', vosotros:'abristeis', ellos:'abrieron' }, subjunctive: { yo:'abra', tu:'abras', el:'abra', nosotros:'abramos', vosotros:'abráis', ellos:'abran' }, imperativoTu: { tu:'abre', tuNeg:'no abras' } } },
    { inf: 'ser', reg: false, zh: '是', forms: { present: { yo:'soy', tu:'eres', el:'es', nosotros:'somos', vosotros:'sois', ellos:'son' }, preterite: { yo:'fui', tu:'fuiste', el:'fue', nosotros:'fuimos', vosotros:'fuisteis', ellos:'fueron' }, subjunctive: { yo:'sea', tu:'seas', el:'sea', nosotros:'seamos', vosotros:'seáis', ellos:'sean' }, imperativoTu: { tu:'sé', tuNeg:'no seas' } } },
    { inf: 'estar', reg: false, zh: '在；处于', forms: { present: { yo:'estoy', tu:'estás', el:'está', nosotros:'estamos', vosotros:'estáis', ellos:'están' }, preterite: { yo:'estuve', tu:'estuviste', el:'estuvo', nosotros:'estuvimos', vosotros:'estuvisteis', ellos:'estuvieron' }, subjunctive: { yo:'esté', tu:'estés', el:'esté', nosotros:'estemos', vosotros:'estéis', ellos:'estén' }, imperativoTu: { tu:'está', tuNeg:'no estés' } } },
    { inf: 'tener', reg: false, zh: '有', forms: { present: { yo:'tengo', tu:'tienes', el:'tiene', nosotros:'tenemos', vosotros:'tenéis', ellos:'tienen' }, preterite: { yo:'tuve', tu:'tuviste', el:'tuvo', nosotros:'tuvimos', vosotros:'tuvisteis', ellos:'tuvieron' }, subjunctive: { yo:'tenga', tu:'tengas', el:'tenga', nosotros:'tengamos', vosotros:'tengáis', ellos:'tengan' }, imperativoTu: { tu:'ten', tuNeg:'no tengas' } } },
    { inf: 'hacer', reg: false, zh: '做', forms: { present: { yo:'hago', tu:'haces', el:'hace', nosotros:'hacemos', vosotros:'hacéis', ellos:'hacen' }, preterite: { yo:'hice', tu:'hiciste', el:'hizo', nosotros:'hicimos', vosotros:'hicisteis', ellos:'hicieron' }, subjunctive: { yo:'haga', tu:'hagas', el:'haga', nosotros:'hagamos', vosotros:'hagáis', ellos:'hagan' }, imperativoTu: { tu:'haz', tuNeg:'no hagas' } } },
    { inf: 'ir', reg: false, zh: '去', forms: { present: { yo:'voy', tu:'vas', el:'va', nosotros:'vamos', vosotros:'vais', ellos:'van' }, preterite: { yo:'fui', tu:'fuiste', el:'fue', nosotros:'fuimos', vosotros:'fuisteis', ellos:'fueron' }, subjunctive: { yo:'vaya', tu:'vayas', el:'vaya', nosotros:'vayamos', vosotros:'vayáis', ellos:'vayan' }, imperativoTu: { tu:'ve', tuNeg:'no vayas' } } },
    { inf: 'querer', reg: false, zh: '想要', forms: { present: { yo:'quiero', tu:'quieres', el:'quiere', nosotros:'queremos', vosotros:'queréis', ellos:'quieren' }, preterite: { yo:'quise', tu:'quisiste', el:'quiso', nosotros:'quisimos', vosotros:'quisisteis', ellos:'quisieron' }, subjunctive: { yo:'quiera', tu:'quieras', el:'quiera', nosotros:'queramos', vosotros:'queráis', ellos:'quieran' }, imperativoTu: { tu:'quiere', tuNeg:'no quieras' } } },
    { inf: 'poder', reg: false, zh: '能', forms: { present: { yo:'puedo', tu:'puedes', el:'puede', nosotros:'podemos', vosotros:'podéis', ellos:'pueden' }, preterite: { yo:'pude', tu:'pudiste', el:'pudo', nosotros:'pudimos', vosotros:'pudisteis', ellos:'pudieron' }, subjunctive: { yo:'pueda', tu:'puedas', el:'pueda', nosotros:'podamos', vosotros:'podáis', ellos:'puedan' }, imperativoTu: { tu:'puede', tuNeg:'no puedas' } } },
    { inf: 'venir', reg: false, zh: '来', forms: { present: { yo:'vengo', tu:'vienes', el:'viene', nosotros:'venimos', vosotros:'venís', ellos:'vienen' }, preterite: { yo:'vine', tu:'viniste', el:'vino', nosotros:'vinimos', vosotros:'vinisteis', ellos:'vinieron' }, subjunctive: { yo:'venga', tu:'vengas', el:'venga', nosotros:'vengamos', vosotros:'vengáis', ellos:'vengan' }, imperativoTu: { tu:'ven', tuNeg:'no vengas' } } },
    { inf: 'decir', reg: false, zh: '说', forms: { present: { yo:'digo', tu:'dices', el:'dice', nosotros:'decimos', vosotros:'decís', ellos:'dicen' }, preterite: { yo:'dije', tu:'dijiste', el:'dijo', nosotros:'dijimos', vosotros:'dijisteis', ellos:'dijeron' }, subjunctive: { yo:'diga', tu:'digas', el:'diga', nosotros:'digamos', vosotros:'digáis', ellos:'digan' }, imperativoTu: { tu:'di', tuNeg:'no digas' } } },
    { inf: 'dar', reg: false, zh: '给', forms: { present: { yo:'doy', tu:'das', el:'da', nosotros:'damos', vosotros:'dais', ellos:'dan' }, preterite: { yo:'di', tu:'diste', el:'dio', nosotros:'dimos', vosotros:'disteis', ellos:'dieron' }, subjunctive: { yo:'dé', tu:'des', el:'dé', nosotros:'demos', vosotros:'deis', ellos:'den' }, imperativoTu: { tu:'da', tuNeg:'no des' } } }
];
